    ...
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          "size-(--cell-size) aria-disabled:opacity-50 p-0 select-none hover:bg-transparent text-black/50 hover:text-black cursor-pointer",
        ...
        dropdowns: cn(
          "  flex items-center text-sm font-medium justify-center w-[200px] h-(--cell-size) gap-1.5",
          defaultClassNames.dropdowns
        ),
        dropdown_root: cn(
          "relative has-focus:border-ring border border-input cursor-pointer  shadow-xs has-focus:ring-primary has-focus:ring-[1px] rounded-md",
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        defaultClassNames.day,
        className,
        "hover:border hover:border-primary  hover:bg-neutral-50 hover:text-black"
      )}
      {...props}
    />  
  )
